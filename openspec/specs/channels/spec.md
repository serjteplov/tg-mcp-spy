# Spec: Telegram channel post cache
...
This spec defines the behavior of the `tg-mcp-spy` MCP server with respect to Telegram channel subscriptions, post caching, and the MCP tool surface.
